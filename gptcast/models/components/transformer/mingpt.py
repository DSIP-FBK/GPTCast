...
class GPTCastConfig(GPTConfig):
    """ GPT-2 Medium like network roughly 350M params """
    n_layer = 24
    n_head = 16
    n_embd = 1024
...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, learning_rate, fused=False):
        """
        ...
        optimizer = torch.optim.AdamW(optim_groups, lr=learning_rate, betas=(0.9, 0.95), fused=fused)
        return optimizer
